...
PRE-LOADED: pd (pandas), np (numpy), frappe, math, datetime, json, re, statistics, random"""
    ...
    def _execute_code_with_timeout(
        ...
        # nosemgrep: frappe-semgrep-rules.rules.security.frappe-subprocess-exec — static argv ([sys.executable, "-m", <fixed module>]), shell=False; user code is passed as JSON over stdin, never as an argument
